...
main_data.prediction.filename = "main_data.prediction.1inc.csv"
main_data.class.filename = "main_data.class.1inc.csv"
...
print(paste(Sys.time(), "3Grams & All Overlapped Features using existing feature - Step: 1"))
...
write.csv(main_data.perf, paste0("3grams/result/kknn-3grams-overlapped.1inc.accuracy.csv"), row.names = FALSE, quote = FALSE)
