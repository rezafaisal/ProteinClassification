...
for(file_i in main_data.files){
  ...
  for(i in 1:nrow(main_data)){
    ...
    main_data.numerical_sum1 = colSums(main_data.numerical[,-1])
    #colnames(main_data.numerical_sum1) = c("SEQ1.", c(1:ncol(main_data.numerical_sum1)))
    # seq 1 ========================================================= end
    ...
    main_data.numerical_sum2 = colSums(main_data.numerical[,-1])
    #colnames(main_data.numerical_sum2) = c("SEQ2.", c(1:ncol(main_data.numerical_sum2)))
    # seq 2 ========================================================= end
    ...
    main_data.numerical_sum3 = colSums(main_data.numerical[,-1])
    #colnames(main_data.numerical_sum3) = c("SEQ3.", c(1:ncol(main_data.numerical_sum3)))
    # seq 3 ========================================================= end
    
    
    main_data.numerical_temp = cbind(rbind(main_data.numerical_sum1), rbind(main_data.numerical_sum2), rbind(main_data.numerical_sum3), datum$class)
  ...
  write.csv(main_data.file.numerical, paste0("3grams/numerical_each/numerical_each.", file_i), row.names = FALSE, quote = FALSE)
}