  ...
  for(divider_i in dividers){
    ...
    for(i in 1:nrow(main_data)){
      ...
      tryCatch({
        ...
        num_feature.test = extractAAC(seq, lambda = 1)
        ...
        #perhitungan feature antara 2 seq 
        #------------------------------------------ start
    ...
    write.csv(main_data.num, paste0("segmented/aac-divider-overlap",divider_i,"-",file_i), row.names = FALSE, quote = FALSE)
    #=================================================================
