...
main_data.prediction.filename = "main_data.prediction.ver1.csv"
main_data.class.filename = "main_data.class.ver1.csv"
features.existing.filename = "kknn-features-rangking-original-overlapped.1inc.950-1050.csv"

#baca features
features.existing = read.csv(paste0("result/overlapped/", features.existing.filename), stringsAsFactors = FALSE)

print(paste(Sys.time(), "ALL-original-overlapped Step: 1 1013-1019 features, ver 4"))
...
write.csv(main_data.perf, paste0("result/overlapped/kknn-cv-original-overlapped.1inc.1013-1019.ver4.csv"), row.names = FALSE, quote = FALSE)
