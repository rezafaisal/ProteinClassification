...
main_data.prediction.filename = "main_data.prediction.3grams-each.ksvm.csv"
main_data.class.filename = "main_data.class.3grams-each.ksvm.csv"


print(paste(Sys.time(), "word2vec feature - each - ksvm"))
