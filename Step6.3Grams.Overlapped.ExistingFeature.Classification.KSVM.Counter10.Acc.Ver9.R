...
main_data.prediction.filename = "main_data.prediction.10inc.ksvm.ver2.csv"
main_data.class.filename = "main_data.class.10inc.ksvm.ver2.csv"
...
print(paste(Sys.time(), "3Grams & All Overlapped Features using existing feature - Step: 10 - KSVM"))
...
write.csv(main_data.perf, paste0("3grams/result/ksvm-3grams-overlapped.10inc.accuracy.ver2.csv"), row.names = FALSE, quote = FALSE)
