...
main_data.prediction.filename = "ksvm-main_data.prediction.50inc.csv"
main_data.class.filename = "ksvm-main_data.class.50inc.csv"
features.existing.filename = "ksvm-features-rangking.50inc.csv"

#baca features
#features.existing = read.csv(paste0("3grams/result/", features.existing.filename), stringsAsFactors = FALSE)

print(paste(Sys.time(), "3Grams & All Overlapped Features - KSVM - Step: 50"))
...
write.csv(main_data.perf, paste0("3grams/result/ksvm-3grams-overlapped.50inc.accuracy.csv"), row.names = FALSE, quote = FALSE)


colnames(main_data.ranking) = paste0("V", c(1:ncol(main_data.ranking)))
write.csv(main_data.ranking, paste0("3grams/result/ksvm-features-rangking-3grams-overlapped.50inc.accuracy.csv"), row.names = FALSE, quote = FALSE)