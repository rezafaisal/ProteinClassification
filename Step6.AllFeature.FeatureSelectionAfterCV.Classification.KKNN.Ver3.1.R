...
write.csv(main_data.perf, paste0("result/kknn-cv-allcombination.fs.divider-ALL-50inc.csv"), row.names = FALSE, quote = FALSE)


colnames(main_data.ranking) = paste0("V", c(1:ncol(main_data.ranking)))
write.csv(main_data.ranking, paste0("combination-all/kknn-50step-features-rangking.csv"), row.names = FALSE, quote = FALSE)