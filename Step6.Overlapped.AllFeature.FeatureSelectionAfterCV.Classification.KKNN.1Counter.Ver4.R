...
k_value = 5
cross_num=5
feature_count.init = 2200
feature_count = 2200
feature_count.max = 2230
feature_increment = 1
...
print(paste("Overlapped Step: 1 - 2200-2230 features"))
...
write.csv(main_data.perf, paste0("result/overlapped/kknn-cv-overlapped.1inc.2200-2230.csv"), row.names = FALSE, quote = FALSE)


colnames(main_data.ranking) = paste0("V", c(1:ncol(main_data.ranking)))
write.csv(main_data.ranking, paste0("result/overlapped/kknn-features-rangking-overlapped.1inc.2200-2230.csv"), row.names = FALSE, quote = FALSE)