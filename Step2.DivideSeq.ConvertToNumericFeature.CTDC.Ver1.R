...
main_data.files = rbind(main_data.files, cbind(c("lyso1.txt","lyso1.txt","lyso1.txt","lyso1.txt","lyso1.txt")))
...
for(file_i in main_data.files){
  ...
  for(divider_i in dividers){
    ...
    write.csv(main_data.num, paste0("segmented/ctdc-divider-",divider_i,"-",file_i), row.names = FALSE, quote = FALSE)
    #=================================================================
