...
main_data.prediction.filename = "main_data.prediction.3grams-all.csv"
main_data.class.filename = "main_data.class.3grams-all.csv"


print(paste(Sys.time(), "word2vec feature - all"))
