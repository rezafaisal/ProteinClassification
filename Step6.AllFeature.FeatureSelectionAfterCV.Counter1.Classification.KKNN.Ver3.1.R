...
k_value = 5
cross_num=5
feature_count.init = 700
feature_count = 700
feature_count.max = 960
feature_increment = 1
...
write.csv(main_data.perf, paste0("result/kknn-cv-allcombination.fs.divider-ALL-counter1.700-960.csv"), row.names = FALSE, quote = FALSE)

colnames(main_data.ranking) = paste0("V", c(1:ncol(main_data.ranking)))
write.csv(main_data.ranking, paste0("combination-all/kknn-1step-features-rangking.700-960.csv"), row.names = FALSE, quote = FALSE)
