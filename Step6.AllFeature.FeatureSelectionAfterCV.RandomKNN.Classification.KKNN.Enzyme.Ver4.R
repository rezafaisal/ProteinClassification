...
write.csv(main_data.perf, paste0("enzymes/result/kknn-cv-allcombination.fs.divider-ALL-counter10.rknn.csv"), row.names = FALSE, quote = FALSE)

colnames(main_data.ranking) = paste0("V", c(1:ncol(main_data.ranking)))
write.csv(main_data.ranking, paste0("enzymes/result/kknn-10step-features-rangking.rknn.csv"), row.names = FALSE, quote = FALSE)
