...
k_value = 5
cross_num=5
feature_count.init = 950
feature_count = 950
feature_count.max = 1050
feature_increment = 1
...
print(paste(Sys.time(), "ALL-original-overlapped Step: 1 950-1050 features, ver 4"))
...
#baca features
features.existing = read.csv("result/overlapped/kknn-features-rangking-original-overlapped.1inc.950-1050.csv", stringsAsFactors = FALSE)
...
write.csv(main_data.perf, paste0("result/overlapped/kknn-cv-original-overlapped.1inc.950-1050.ver4.csv"), row.names = FALSE, quote = FALSE)


colnames(main_data.ranking) = paste0("V", c(1:ncol(main_data.ranking)))
write.csv(main_data.ranking, paste0("result/overlapped/kknn-features-rangking-original-overlapped.1inc.950-1050.ver4.csv"), row.names = FALSE, quote = FALSE)