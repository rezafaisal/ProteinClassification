...
k_value = 5
cross_num=5
feature_count.init = 420
feature_count = 420
feature_count.max = 450
feature_increment = 1
...
write.csv(main_data.perf, paste0("result/kknn-cv-420-450-combination.fs.divider-", divider_j,".csv"), row.names = FALSE, quote = FALSE)
