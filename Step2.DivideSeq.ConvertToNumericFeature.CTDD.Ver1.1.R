...
main_data.files = cbind(c("golgi1.txt","golgi2.txt","golgi3.txt","golgi4.txt","golgi5.txt"))
...
for(file_i in main_data.files){
  ...
  for(divider_i in dividers){
    ...
    write.csv(main_data.num, paste0("segmented/ctdd-divider-",divider_i,"-",file_i), row.names = FALSE, quote = FALSE)
    #=================================================================
